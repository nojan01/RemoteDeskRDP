# RemoteDeskRDP – technische Spezifikation

## Ziel

RemoteDeskRDP ist ein eigenständiger Remote-Desktop-Client für **macOS 26.0
oder neuer**. Er wird als signierte, notarisierte `RemoteDeskRDP.app` ausgeliefert
...
Abschnitte: die MIT-Lizenz der Anwendung, die Liste aller mitgelieferten Module
mit ihren Lizenzen, den Hinweis zur Quelltextbereitstellung und die Aufstellung
der geänderten Dateien in FreeRDP und SDL.
...
Der eigene Quellcode steht unter der [MIT-Lizenz](../LICENSE). Für die
mitgelieferten Bibliotheken gelten unabhängig davon deren jeweilige Lizenzen;
